...
var minHandle = document.querySelector('#filter-price .slider-handle.min-slider-handle.round');
var maxHandle = document.querySelector('#filter-price .slider-handle.max-slider-handle.round');
